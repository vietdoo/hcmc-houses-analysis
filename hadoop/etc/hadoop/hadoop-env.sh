...
export HDFS_NAMENODE_USER=jayson
export HDFS_DATANODE_USER=jayson
export HDFS_SECONDARYNAMENODE_USER=jayson
export YARN_RESOURCEMANAGER_USER=jayson
export YARN_NODEMANAGER_USER=jayson
